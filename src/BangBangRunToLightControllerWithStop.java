...
public class BangBangRunToLightControllerWithStop extends DifferentialWheels {
    //setup values
    ...
    public BangBangRunToLightControllerWithStop() {
        super();
    ...
    private boolean checkFullStop() {
        if ((_lightSensors[L_FRONT_LEFT].getValue() < LIGHT_THRESHOLD) || (_lightSensors[L_FRONT_RIGHT].getValue() < LIGHT_THRESHOLD)){
    ...
    public static void main(String[] args) {
        BangBangRunToLightControllerWithStop controller = new BangBangRunToLightControllerWithStop();
        controller.run();
    }
}